...
var wordcount = (function () {
  ...
  var $_94ze48rrjd24rljt = {
    each: each,
    map: map
  };

  var SETS$1 = $_bgl356rpjd24rljo.SETS;
  var OTHER = $_bgl356rpjd24rljo.characterIndices.OTHER;
  ...
  var classify = function (string) {
    ...
    return $_94ze48rrjd24rljt.map(string.split(''), memoized);
  };
  var $_82dt4vrqjd24rljr = { classify: classify };

  var ci = $_bgl356rpjd24rljo.characterIndices;
  ...
  var $_9lk4t8rsjd24rljv = { isWordBoundary: isWordBoundary };

  var EMPTY_STRING$1 = $_bgl356rpjd24rljo.EMPTY_STRING;
  var WHITESPACE$1 = $_bgl356rpjd24rljo.WHITESPACE;
  var PUNCTUATION$1 = $_bgl356rpjd24rljo.PUNCTUATION;
  ...
  var doGetWords = function (str, options) {
    var i = 0;
    var map = $_82dt4vrqjd24rljr.classify(str);
    var len = map.length;
    var word = [];
    var words = [];
    var chr;
    ...
    for (; i < len; ++i) {
      chr = str.charAt(i);
      word.push(chr);
      if ($_9lk4t8rsjd24rljv.isWordBoundary(map, i)) {
  ...
  var $_e6ilnorojd24rljg = { getWords: getWords };

  var getTextContent = function (editor) {
    return editor.removed ? '' : editor.getBody().innerText;
  };
  var getCount = function (editor) {
    return $_e6ilnorojd24rljg.getWords(getTextContent(editor)).length;
  };
  var $_8jjabwrnjd24rlje = { getCount: getCount };

  var get = function (editor) {
    var getCount = function () {
      return $_8jjabwrnjd24rlje.getCount(editor);
    };
    return { getCount: getCount };
  };
  var $_cglijqrmjd24rljd = { get: get };
  ...
  var setup = function (editor) {
    var wordsToText = function (editor) {
      return I18n.translate([
        '{0} words',
        $_8jjabwrnjd24rlje.getCount(editor)
      ]);
    };
    var update = function () {
  ...
  var $_clv49lrtjd24rljx = { setup: setup };

  PluginManager.add('wordcount', function (editor) {
    $_clv49lrtjd24rljx.setup(editor);
    return $_cglijqrmjd24rljd.get(editor);
  });
  function Plugin () {
  }
