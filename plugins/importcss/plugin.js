...
var importcss = (function () {
  ...
  var defaultConvertSelectorToFormat = function (editor, selectorText) {
    ...
    if ($_c5awsrdwjd24rjjs.shouldMergeClasses(editor) !== false) {
  ...
  var isExclusiveMode = function (editor, group) {
    return group === null || $_c5awsrdwjd24rjjs.shouldImportExclusive(editor) !== false;
  };
  ...
  var convertSelectorToFormat = function (editor, plugin, selector, group) {
    ...
    } else if ($_c5awsrdwjd24rjjs.getSelectorConverter(editor)) {
      selectorConverter = $_c5awsrdwjd24rjjs.getSelectorConverter(editor);
    } else {
  ...
  var setup = function (editor) {
    editor.on('renderFormatsMenu', function (e) {
      ...
      var selectorFilter = compileFilter($_c5awsrdwjd24rjjs.getSelectorFilter(editor)), ctrl = e.control;
      var groups = compileUserDefinedGroups($_c5awsrdwjd24rjjs.getCssGroups(editor));
      ...
      if (!$_c5awsrdwjd24rjjs.shouldAppend(editor)) {
        ctrl.items().remove();
      }
      Tools.each(getSelectors(editor, e.doc || editor.getDoc(), compileFilter($_c5awsrdwjd24rjjs.getFileFilter(editor))), function (selector) {
  ...
  var get = function (editor) {
    var convertSelectorToFormat = function (selectorText) {
      return $_dxuznddrjd24rjjd.defaultConvertSelectorToFormat(editor, selectorText);
    };
    return { convertSelectorToFormat: convertSelectorToFormat };
  };
  var $_65zmjjdqjd24rjj8 = { get: get };

  PluginManager.add('importcss', function (editor) {
    $_dxuznddrjd24rjjd.setup(editor);
    return $_65zmjjdqjd24rjj8.get(editor);
  });
  function Plugin () {
  }
