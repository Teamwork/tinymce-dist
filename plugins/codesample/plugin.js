...
var codesample = (function () {
  ...
  var getSelectedCodeSample = function (editor) {
    ...
    if ($_fedzrq9ejd24ritd.isCodeSample(node)) {
      return node;
    }
    return null;
  };
  ...
  var getLanguages$1 = function (editor) {
    ...
    var customLanguages = $_blza849ajd24risd.getLanguages(editor);
    return customLanguages ? customLanguages : defaultLanguages;
  };
  var getCurrentLanguage = function (editor) {
    var matches;
    var node = $_a2k3pv9cjd24risg.getSelectedCodeSample(editor);
    if (node) {
  ...
  var $_95pk9f9fjd24ritf = {
    getLanguages: getLanguages$1,
    getCurrentLanguage: getCurrentLanguage
  };

  var $_7hivtf99jd24risb = {
    open: function (editor) {
      var minWidth = $_blza849ajd24risd.getDialogMinWidth(editor);
      var minHeight = $_blza849ajd24risd.getDialogMinHeight(editor);
      var currentLanguage = $_95pk9f9fjd24ritf.getCurrentLanguage(editor);
      var currentLanguages = $_95pk9f9fjd24ritf.getLanguages(editor);
      var currentCode = $_a2k3pv9cjd24risg.getCurrentCode(editor);
      editor.windowManager.open({
        ...
        onSubmit: function (e) {
          $_a2k3pv9cjd24risg.insertCodeSample(editor, e.data.language, e.data.code);
        }
      });
    }
  };
  ...
  var register = function (editor) {
    editor.addCommand('codesample', function () {
      var node = editor.selection.getNode();
      if (editor.selection.isCollapsed() || $_fedzrq9ejd24ritd.isCodeSample(node)) {
        $_7hivtf99jd24risb.open(editor);
      } else {
        editor.formatter.toggle('code');
      }
    });
  };
  var $_268wri98jd24ris9 = { register: register };

  var setup = function (editor) {
    var $ = editor.$;
    editor.on('PreProcess', function (e) {
      $('pre[contenteditable=false]', e.node).filter($_fedzrq9ejd24ritd.trimArg($_fedzrq9ejd24ritd.isCodeSample)).each(function (idx, elm) {
    ...
    editor.on('SetContent', function () {
      var unprocessedCodeSamples = $('pre').filter($_fedzrq9ejd24ritd.trimArg($_fedzrq9ejd24ritd.isCodeSample)).filter(function (idx, elm) {
  ...
  var $_6cp8i99gjd24rith = { setup: setup };

  var loadCss = function (editor, pluginUrl, addedInlineCss, addedCss) {
    var linkElm;
    var contentCss = $_blza849ajd24risd.getContentCss(editor);
  ...
  var $_4v9qh29hjd24ritj = { loadCss: loadCss };
  ...
  var $_enauog9ijd24ritl = { register: register$1 };

  var addedInlineCss = Cell(false);
  PluginManager.add('codesample', function (editor, pluginUrl) {
    var addedCss = Cell(false);
    $_6cp8i99gjd24rith.setup(editor);
    $_enauog9ijd24ritl.register(editor);
    $_268wri98jd24ris9.register(editor);
    editor.on('init', function () {
      $_4v9qh29hjd24ritj.loadCss(editor, pluginUrl, addedInlineCss, addedCss);
    });
    editor.on('dblclick', function (ev) {
      if ($_fedzrq9ejd24ritd.isCodeSample(ev.target)) {
        $_7hivtf99jd24risb.open(editor);
      }
    });
  });
