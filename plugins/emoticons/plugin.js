...
var emoticons = (function () {
  ...
  var $_84bkwca8jd24rix6 = { getHtml: getHtml };
  ...
  var register = function (editor, pluginUrl) {
    var panelHtml = $_84bkwca8jd24rix6.getHtml(pluginUrl);
  ...
  var $_cm1fvga7jd24rix3 = { register: register };

  PluginManager.add('emoticons', function (editor, pluginUrl) {
    $_cm1fvga7jd24rix3.register(editor, pluginUrl);
  });
  function Plugin () {
  }
