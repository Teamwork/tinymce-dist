...
var contextmenu = (function () {
  ...
  var $_d9bcgu9tjd24rivh = { getPos: getPos };
  ...
  var renderMenu = function (editor, visibleState) {
    ...
    var items = [];
    contextmenu = $_46nkk29sjd24rivf.getContextMenu(editor);
  ...
  var $_5a3c4r9wjd24rivm = { show: show };

  var isNativeOverrideKeyEvent = function (editor, e) {
    return e.ctrlKey && !$_46nkk29sjd24rivf.shouldNeverUseNative(editor);
  };
  var setup = function (editor, visibleState, menu) {
    editor.on('contextmenu', function (e) {
      ...
      e.preventDefault();
      $_5a3c4r9wjd24rivm.show(editor, $_d9bcgu9tjd24rivh.getPos(editor, e), visibleState, menu);
    });
  };
  var $_cyppcu9rjd24rivd = { setup: setup };

  PluginManager.add('contextmenu', function (editor) {
    var menu = Cell(null), visibleState = Cell(false);
    $_cyppcu9rjd24rivd.setup(editor, visibleState, menu);
    return $_b3hhy19qjd24rivc.get(visibleState);
  });
  function Plugin () {
  }
