...
var toc = (function () {
  ...
  var $_28ypiqljd24rlfs = { create: create };

  var tocId = $_28ypiqljd24rlfs.create('mcetoc_');
  ...
  var readHeaders = function (editor) {
    var tocClass = $_c76w7lqkjd24rlfq.getTocClass(editor);
    var headerTag = $_c76w7lqkjd24rlfq.getTocHeader(editor);
    var selector = generateSelector($_c76w7lqkjd24rlfq.getTocDepth(editor));
  ...
  var generateTocHtml = function (editor) {
    ...
    return '<div class="' + editor.dom.encode($_c76w7lqkjd24rlfq.getTocClass(editor)) + '" contenteditable="false">' + html + '</div>';
  };
  var generateTocContentHtml = function (editor) {
    ...
    html += generateTitle($_c76w7lqkjd24rlfq.getTocHeader(editor), I18n.translate('Table of Contents'));
    for (i = 0; i < headers.length; i++) {
      h = headers[i];
      h.element.id = h.id;
  ...
  var register = function (editor) {
    editor.addCommand('mceInsertToc', function () {
      $_3i6grcqgjd24rlfm.insertToc(editor);
    });
    editor.addCommand('mceUpdateToc', function () {
      $_3i6grcqgjd24rlfm.updateToc(editor);
    });
  };
  var $_7p0tdyqfjd24rlfk = { register: register };

  var setup = function (editor) {
    var $ = editor.$, tocClass = $_c76w7lqkjd24rlfq.getTocClass(editor);
  ...
  var $_61tohhqmjd24rlft = { setup: setup };

  var toggleState = function (editor) {
    return function (e) {
      var ctrl = e.control;
      editor.on('LoadContent SetContent change', function () {
        ctrl.disabled(editor.readonly || !$_3i6grcqgjd24rlfm.hasHeaders(editor));
      });
    };
  };
  var isToc = function (editor) {
    return function (elm) {
      return elm && editor.dom.is(elm, '.' + $_c76w7lqkjd24rlfq.getTocClass(editor)) && editor.getBody().contains(elm);
    };
  };
  ...
  var $_6f1bbnqnjd24rlfu = { register: register$1 };

  PluginManager.add('toc', function (editor) {
    $_7p0tdyqfjd24rlfk.register(editor);
    $_6f1bbnqnjd24rlfu.register(editor);
    $_61tohhqmjd24rlft.setup(editor);
  });
  function Plugin () {
  }
